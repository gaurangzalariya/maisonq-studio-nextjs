...
export const content: ServicePageContent = {
  hero: {
    heading: "Shopify & Shopify Plus Development, Done Right",
    subtext: "Custom themes. Conversion-focused UX. Seamless integrations. Built for scaling brands on Shopify.",
    ctaLabel: "Let's Build Your Shopify Store",
  },
  services: {
    ...
    list: [
      ...
      { label: "Conversion-focused UX & buyer flows", iconName: "MousePointerClick" },
      { label: "Shopify Plus migrations & setup", iconName: "MoveUpRight" },
      { label: "Klaviyo, ReCharge, and 3rd-party app integrations", iconName: "Zap" },
      { label: "Headless builds using Hydrogen or custom stacks", iconName: "Layers3" },
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Yes, we specialize in seamless migrations from platforms like WooCommerce, Magento, BigCommerce, or custom setups. We ensure product data, customer info, SEO URLs, and order history are preserved and optimized.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, we handle integrations with Klaviyo, ReCharge, Gorgias, ShipStation, and other tools. We also build custom features using Shopify's APIs and app extensions when out-of-the-box solutions aren't enough.",
    },
    {
    ...
    },
    {
      ...
      answer: "Definitely. We often collaborate with in-house teams, agencies, or freelancers. Whether you need us to build from your Figma designs or help implement growth experiments, we're flexible and collaborative.",
    },
    {
      question: "Do you help with site speed and Core Web Vitals?",
      answer: "Yes. Site performance is a major part of our process. We optimize image delivery, reduce unused code, improve Liquid structure, and tune scripts for better scores in Google PageSpeed Insights and Lighthouse.",
    },
    {
